...
43. [ShellCheck CI Parity](../repo-automation/docs/shellcheck-ci-parity.md)
44. [Starter Template Readiness](../repo-automation/docs/starter-template-readiness.md)
45. [Repo Automation Install](../repo-automation/docs/repo-automation-install.md)
46. [Starter Template Smoke Workflow](../repo-automation/docs/testing.md)
47. [Command Shape](../repo-automation/docs/command-shape.md)
48. [Output Modes](../repo-automation/docs/output-modes.md)
49. [Testing](../repo-automation/docs/testing.md)
