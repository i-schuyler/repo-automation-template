...
49. [Codex Status Timing UI Contract](../repo-automation/docs/contracts/codex-status-timing-ui-contract.md)
50. [Slice Handoff Final Summary UI Contract](../repo-automation/docs/contracts/slice-handoff-final-summary-contract.md)
51. [Starter Template Smoke Workflow](../repo-automation/docs/testing.md)
52. [Command Shape](../repo-automation/docs/command-shape.md)
53. [Output Modes](../repo-automation/docs/output-modes.md)
54. [Testing](../repo-automation/docs/testing.md)
55. [Downstream Install Contract](../repo-automation/docs/downstream-install-contract.md)
