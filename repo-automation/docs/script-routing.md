...
For the starter/reference split, see [docs/SURFACE_MAP.md](../../docs/SURFACE_MAP.md).
...
| Codex adapter | `codex-run` | no | yes | no | no | no | `slice-handoff`; supports explicit model/reasoning passthrough from handoff envelopes |
