...
- installed `repo-automation/bin/failure-log`, `repo-automation/bin/status-packet`, `repo-automation/bin/post-codex-packet`, `repo-automation/bin/repo-zip`, and `repo-automation/bin/evidence-bundle` as part of the default downstream install contract
