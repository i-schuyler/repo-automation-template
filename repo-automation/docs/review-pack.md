...
- `--target=review` creates an upload-friendly review bundle in `${REPO_AUTOMATION_OUTPUT_DIR:-${TMPDIR:-$HOME/.cache}/repo-automation}/review-pack`
...
- `--target=review` prints the review bundle zip path
