...
- 2026-06-07 / PR #233 follow-up / slice-handoff execution-submit state drift / ids=slice-handoff-contract-opacity / score_delta=0 / signal=execution-submit success still shared mutable fixture state with later submit subcases, so the modular wrapper needs tighter per-scenario artifact isolation even though the underlying run-dir artifacts were correct
