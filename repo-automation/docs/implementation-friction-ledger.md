...
- 2026-06-03 / slice-handoff-blocker-semantics-discoverability / ids=none / score_delta=+5 / signal=added Codex final-output semantic gating before PR-body validation and submit so blocker output cannot cross the trust boundary
