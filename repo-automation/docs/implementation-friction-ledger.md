...
- 2026-06-06 / PR #232 / ci-log-dump output-contract baseline / ids=none / score_delta=0 / signal=focused output-mode conflict, quiet, machine-json, and artifact-path coverage landed without material friction
