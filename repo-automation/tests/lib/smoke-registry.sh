...
smoke_contract_names=(
  ...
  "smoke:slice-validator-contract"
  "smoke:slice-run-dir-contract"
...
smoke_contract_scripts=(
  ...
  "repo-automation/tests/contracts/slice-validator.sh"
